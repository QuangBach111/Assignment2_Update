...
// Generate table rows for each poll
    ...
    itemList.forEach(function (item) {
        ...
        pollList.forEach(function (poll, index) {
            ...
            tableRows += '<td>' + poll.name + '<span class="badge badge-primary ml-2 poll-status">' + pollStatus + '</span>' + '<br style="border-top: 1px solid #000;"> <hr> <b>Created by</b>: ' + '<span class="badge badge-danger ml-2">' + userName + '</span>' + '</td>';
            tableRows += '<td>';
